...
export default class TransactionScreen extends React.Component {
        ...
        return(
         ...
         <Image source={require('../assets/booklogo.jpg')} style={{
           ...
           <View style={styles.inputView}>
            <TextInput style={styles.inputBox} value= {this.state.bookId}></TextInput>
           ...
           <View style={styles.inputView}>
            <TextInput style={styles.inputBox} value= {this.state.studentId}></TextInput>
  ...
  const styles = StyleSheet.create({
    ...
    scanbutton: { backgroundColor: "blue", width: 50, borderWidth: 1.5, borderLeftWidth: 0 
    },
  });